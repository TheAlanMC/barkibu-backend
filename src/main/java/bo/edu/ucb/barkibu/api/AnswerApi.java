...
public class AnswerApi {
    ...
    @PostMapping()
    public ResponseEntity<ResponseDto<String>> createAnswer(@RequestHeader Map<String, String> headers,
    ...
    @PutMapping()
    public ResponseEntity<ResponseDto<String>> updateAnswer(@RequestHeader Map<String, String> headers,
            @RequestBody AnswerDto answerDto) {
        if (answerDto.validate()) {
            try {
                // Verificamos que el usuario este autenticado
    ...
    public ResponseEntity<ResponseDto<String>> likeAnswer(@RequestHeader Map<String, String> headers,
